...
/**
 * InsightOpenNewRecommendationsHandler for requests to Lambda function.
 */
public class InsightOpenNewRecommendationsHandler implements RequestHandler<Map<String, Object>, String> {
    ...
    public String handleRequest(Map<String, Object> input, final Context context) {
        ...
        // Filter only messageType of new NEW_INSIGHT and NEW_RECOMMENDATION
        if ("NEW_INSIGHT".equals(messageType) || "NEW_RECOMMENDATION".equals(messageType)) {
