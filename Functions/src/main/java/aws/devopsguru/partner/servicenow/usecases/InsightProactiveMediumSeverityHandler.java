...
/**
 * InsightProactiveMediumSeverityHandler for requests to Lambda function.
 */
public class InsightProactiveMediumSeverityHandler implements RequestHandler<Map<String, Object>, String> {
    ...
    public String handleRequest(Map<String, Object> input, final Context context) {
        ...
        // Filter only Proactive and Medium severity insights
