...
/**
 * InsightReactiveHighSeverityHandler for requests to Lambda function.
 */
public class InsightReactiveHighSeverityHandler implements RequestHandler<Map<String, Object>, String> {
    ...
    public String handleRequest(Map<String, Object> input, final Context context) {
        ...
        // Filter only Reactive and High severity insights
