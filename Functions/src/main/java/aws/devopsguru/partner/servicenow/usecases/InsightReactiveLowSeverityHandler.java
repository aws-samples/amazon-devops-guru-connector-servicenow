...
/**
 * InsightReactiveLowSeverityHandler for requests to Lambda function.
 */
public class InsightReactiveLowSeverityHandler implements RequestHandler<Map<String, Object>, String> {
